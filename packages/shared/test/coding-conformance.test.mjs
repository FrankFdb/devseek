...
test('coding conformance catalog freezes eight Codex and Claude Code observable behavior fixtures', () => {
  assert.equal(CODING_CONFORMANCE_DEVELOPMENT_FIXTURES.length, 8);
  assert.deepEqual(
...
test('one settled projection owner keeps all eight fixtures equivalent across three Surfaces', () => {
  for (const fixture of CODING_CONFORMANCE_DEVELOPMENT_FIXTURES) {
