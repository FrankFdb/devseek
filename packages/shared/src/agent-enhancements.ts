  ...
  for (const [index, line] of lines.entries()) {
    ...
    if (
      ...
      && (
        ...
        || SKILL_METADATA_MARKDOWN_DEFINITION_LIST_DETAIL_MARKER.test(nextTrimmed)
      )
    ) {
      insideBodySection = true;
      continue;
    }
    if (!isFrontmatterMetadataLine && SKILL_METADATA_MARKDOWN_DEFINITION_LIST_DETAIL_MARKER.test(metadataTrimmed)) {
      insideBodySection = true;
      continue;
    }
    ...
    if (!isFrontmatterMetadataLine && SKILL_METADATA_MARKDOWN_ESCAPED_AUTOLINK_MARKER.test(metadataTrimmed)) {
      insideBodySection = true;
      continue;
    }
    if (!isFrontmatterMetadataLine && SKILL_METADATA_MARKDOWN_ESCAPED_HTML_MARKER.test(metadataTrimmed)) {
      insideBodySection = true;
      continue;
    }
    ...
    if (!isFrontmatterMetadataLine && SKILL_METADATA_MARKDOWN_BLOCKQUOTE_MARKER.test(metadataTrimmed)) {
      insideBodySection = true;
      continue;
    }
    ...
    if (!isFrontmatterMetadataLine && SKILL_METADATA_MARKDOWN_LINK_MARKER.test(metadataTrimmed)) {
      insideBodySection = true;
      continue;
    }
