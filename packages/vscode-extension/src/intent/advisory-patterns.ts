...
const DELIVERABLE_PATH_ACTION_RE = /(?:新增|创建|新建|生成|编写|写入|输出|保存|落盘|放入|放到|写到|存到|翻译|总结|摘要|概括|提取|重命名|移动|复制|追加|插入|create|generate|write|save|output|translate|summari[sz]e|rename|move|copy|append|insert)/gi;
