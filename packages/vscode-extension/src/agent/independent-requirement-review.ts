  ...
  return [
    {
      ...
      content: [
        ...
        'The required result in each counterexample must be directly traceable to words in the exact requirement or an explicitly supplied contract. If that trace cannot be stated, omit the finding.',
