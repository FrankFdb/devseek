...
export function buildFallbackRequestCopy(
  ...
  if (request.traceSamplingId !== undefined) copy.traceSamplingId = request.traceSamplingId;
  if (request.traceTransportAttempt !== undefined) copy.traceTransportAttempt = request.traceTransportAttempt;
