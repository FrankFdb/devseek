...
function controlledScenarioCatalog() {
  ...
  return {
    ...
    't1-direct-cn-screenshot-explain': {
      id: 't1-direct-cn-screenshot-explain',
      kind: 't1-direct-screenshot-concept-answer',
      ...
      providerAnswer: 'CPU 擅长通用、低延迟任务；GPU 擅长同时处理大量相似计算。',
      expected: 'completed-advisory-no-mutation',
      expectedFiles: { 'README.md': safeBaselineContent },
      expectedChangedPaths: [],
      expectedMutatedUserFiles: [],
      ...
      requiredRunLogSubstrings: ['CPU 擅长通用、低延迟任务'],
    ...
    't1-followup-cn-anchor': {
      id: 't1-followup-cn-anchor',
      kind: 't1-direct-followup-anchor-answer',
    ...
    't1-followup-cn-detail': {
      id: 't1-followup-cn-detail',
      kind: 't1-elliptical-followup-detailed-answer',
      userProfile: 'iterative-novice',
      languageStyle: 'zh-elliptical-followup',
      intentClass: 'same-session-referent-expansion',
      targetRelativePath: 'README.md',
      targetContent: safeBaselineContent,
      prompt: '再详细说明他们的差异',
      providerPlan: 'direct-assistant-answer',
      providerAnswer: 'CPU 核心较少但单核强、延迟低，适合操作系统和分支复杂的通用任务；GPU 核心多、吞吐量高，适合图形渲染、矩阵运算和模型训练。',
      requiredProviderPromptSubstrings: [
        '说明gpu cpu',
        'CPU 擅长通用、低延迟任务',
      ],
    ...
    'conformance-project-health-repair': {
      id: 'conformance-project-health-repair',
      conformanceFixtureId: 'implicit-project-health-repair',
      kind: 'coding-conformance-implicit-project-health-repair',
      targetRelativePath: 'src/parser.js',
      targetContent: parserFixedContent,
      firstRepairContent: parserFirstRepairContent,
      seedFiles: { 'src/parser.js': parserBrokenContent },
    ...
    'conformance-runtime-error-repair': {
      id: 'conformance-runtime-error-repair',
      conformanceFixtureId: 'implicit-runtime-error-repair',
      kind: 'coding-conformance-implicit-runtime-error-repair',
      targetRelativePath: 'src/parser.js',
      targetContent: parserFixedContent,
      firstRepairContent: parserFirstRepairContent,
      seedFiles: { 'src/parser.js': parserBrokenContent },
    ...
    'conformance-user-symptom-repair': {
      id: 'conformance-user-symptom-repair',
      conformanceFixtureId: 'implicit-user-symptom-repair',
      kind: 'coding-conformance-implicit-user-symptom-repair',
      targetRelativePath: 'src/parser.js',
      targetContent: parserFixedContent,
      firstRepairContent: parserFirstRepairContent,
      seedFiles: { 'src/parser.js': parserBrokenContent },
