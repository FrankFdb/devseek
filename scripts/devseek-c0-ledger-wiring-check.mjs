...
const paths = {
  ...
  c0WiringReconciliationChecker: processPath('scripts/devseek-c0-wiring-reconciliation-check.mjs'),
...
try {
  sources = {
    ...
    sourceContents: {
      ...
      'scripts/devseek-c0-wiring-reconciliation-check.mjs': readText(paths.c0WiringReconciliationChecker),
