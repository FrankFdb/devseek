...
const SOURCE_PATHS = Object.freeze({
  ...
  sharedModelActionContract: 'packages/shared/src/coding-model-action-contract.ts',
  ...
  sharedCodeChange: 'packages/shared/src/coding-code-change.ts',
  sharedIntegrationConformance: 'packages/shared/src/coding-integration-conformance.ts',
  ...
  sharedDiagnostic: 'packages/shared/src/coding-diagnostic.ts',
  sharedRegressionSelection: 'packages/shared/src/coding-regression-selection.ts',
  sharedRepairDecision: 'packages/shared/src/coding-repair-decision.ts',
  sharedIndependentReview: 'packages/shared/src/coding-independent-review.ts',
  ...
  sharedReceiptAcceptance: 'packages/shared/src/coding-receipt-acceptance.ts',
  ...
  vscodeCodingKernelOutput: 'packages/vscode-extension/src/app/vscode-coding-kernel-output.ts',
  ...
  sessionPersistence: 'packages/vscode-extension/src/app/session-persistence-coordinator.ts',
  ...
  vscodeModelLedSemanticContract: 'packages/vscode-extension/src/intent/model-led-semantic-contract.ts',
  vscodeModelActionSemanticContract: 'packages/vscode-extension/src/intent/model-action-semantic-contract.ts',
});
...
const SOURCE_CHECKS = Object.freeze([
  ...
  check('shared-canonical-coding-kernel', SOURCE_PATHS.sharedCodingKernel, [
    ...
    'new CanonicalCodeChangeService()',
    'new CanonicalIntegrationConformanceService()',
    'new CanonicalDiagnosticService()',
    'new CanonicalRegressionSelectionService()',
    'new CanonicalRepairDecisionService()',
    'new CanonicalIndependentReviewService()',
    'new CanonicalArtifactIdentityService()',
    'new CanonicalGitDeliveryService()',
    'new CanonicalDeliveryManifestService()',
    'new CanonicalReleaseGateService()',
    'new CanonicalCiDeployObserveService()',
    'new CanonicalRollbackService()',
    'new CanonicalReceiptAcceptanceEvidenceService()',
  ...
  check('shared-canonical-orientation-decision-owner', SOURCE_PATHS.sharedOrientation, [
    "CODING_ORIENTATION_DECISION_VERSION = 'devseek.coding-orientation-decision/v2'",
    ...
    'coding-orientation:',
  ], ["from 'vscode'", 'TaskIntentRoute', 'ExecutionMode', 'EXPLICIT_CHANGE_RE']),
  ...
  check('vscode-model-led-pre-action-semantic-boundary', SOURCE_PATHS.vscodeModelLedSemanticContract, [
  ...
  ], ['resolveCodingOrientationDecision(', 'projectModelActionSemanticContract(']),
  check('vscode-normalized-model-action-semantic-projection', SOURCE_PATHS.vscodeModelActionSemanticContract, [
    ...
    "action.mutation === 'create-file' || action.mutation === 'modify-source'",
  ...
  ], ['resolveCodingOrientationDecision(', 'userPrompt']),
  ...
  check('shared-normalized-model-action-task-contract-owner', SOURCE_PATHS.sharedModelActionContract, [
  ...
  ], ["from 'vscode'", 'RegExp', 'extractCodingWorkspacePaths']),
  ...
  check('shared-canonical-code-change-owner', SOURCE_PATHS.sharedCodeChange, [
    "CODING_CODE_CHANGE_DECISION_VERSION = 'devseek.coding-code-change-decision/v1'",
    ...
    'unplanned-path-mutated',
    'coding-code-change:',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  check('shared-canonical-integration-conformance-owner', SOURCE_PATHS.sharedIntegrationConformance, [
    "CODING_INTEGRATION_CONFORMANCE_VERSION = 'devseek.coding-integration-conformance/v1'",
    ...
    'workspace-mutation-bypassed-tool-execution',
    'mutating-tool-missing-transaction-receipt',
    'coding-integration-conformance:',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  ...
  check('shared-canonical-diagnostic-owner', SOURCE_PATHS.sharedDiagnostic, [
    "CODING_DIAGNOSTIC_DECISION_VERSION = 'devseek.coding-diagnostic-decision/v1'",
    'export interface DiagnosticPort',
    'export class CanonicalDiagnosticService implements DiagnosticServicePort',
    'normalizeVerification(receipt: CodingVerificationReceipt)',
    'diagnostic-fingerprint:',
    'coding-diagnostic:',
  ], ["from 'vscode'", 'CliVerificationAdapter', 'HeadlessVerificationAdapter']),
  check('shared-canonical-regression-selection-owner', SOURCE_PATHS.sharedRegressionSelection, [
    "CODING_REGRESSION_SELECTION_VERSION = 'devseek.coding-regression-selection/v1'",
    ...
    'regression-acceptance-coverage-expanded',
    'coding-regression-selection:',
  ], ["from 'vscode'", 'CliVerificationAdapter', 'HeadlessVerificationAdapter']),
  check('shared-canonical-repair-decision-owner', SOURCE_PATHS.sharedRepairDecision, [
    "CODING_REPAIR_DECISION_VERSION = 'devseek.coding-repair-decision/v1'",
    ...
    'coding-repair-decision:',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'AgenticRepairService']),
  check('shared-canonical-independent-review-owner', SOURCE_PATHS.sharedIndependentReview, [
    "CODING_INDEPENDENT_REVIEW_DECISION_VERSION =",
    ...
    'review-verification-not-passed',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  check('shared-canonical-artifact-identity-owner', SOURCE_PATHS.sharedArtifactIdentity, [
    ...
    'artifactSetFingerprint = codingSemanticDigest(',
    'required-artifact-missing',
    'artifact-identity-invalid',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  check('shared-canonical-delivery-owners', SOURCE_PATHS.sharedDelivery, [
    "CODING_GIT_DELIVERY_DECISION_VERSION =",
    "CODING_DELIVERY_MANIFEST_VERSION = 'devseek.coding-delivery-manifest/v1'",
    ...
    "effect?.effects.includes('git')",
    'git-review-fingerprint-mismatch',
    'settledCodingVerificationReceipts(',
    'delivery-manifest:fingerprint:',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  check('shared-canonical-release-owners', SOURCE_PATHS.sharedRelease, [
    "CODING_RELEASE_GATE_DECISION_VERSION = 'devseek.coding-release-gate-decision/v1'",
    "CODING_DEPLOYMENT_DECISION_VERSION = 'devseek.coding-deployment-decision/v1'",
    "CODING_ROLLBACK_DECISION_VERSION = 'devseek.coding-rollback-decision/v1'",
    ...
    'deployment-stage-order-invalid',
    'rollback-target-mismatch',
  ], ["from 'vscode'", 'CliCodingKernelRuntimeAdapter', 'HeadlessCodingKernelExecutor']),
  check('shared-receipt-acceptance-evidence-owner', SOURCE_PATHS.sharedReceiptAcceptance, [
    ...
    'receipt.readbackRef',
    'authorityReceiptMatchesExecution(receipt)',
  ...
  check('vscode-coding-conformance-product-output-probe', SOURCE_PATHS.vscodeCodingConformanceProbe, [
    ...
    'VS Code product projection includes only exact action-owned verification receipts',
  ...
  check('vscode-coding-conformance-action-owned-projection', SOURCE_PATHS.vscodeCodingKernelOutput, [
  ...
  check('vscode-session-persistence-boundary', SOURCE_PATHS.sessionPersistence, [
  ...
  check('vscode-session-continuation-domain-owner', SOURCE_PATHS.sessionContext, [
    ...
    'mode: projectionMode(',
  ], ['shouldInjectSessionContinuationForIntent(', 'classifyIntent']),
  ...
  check('vscode-shared-kernel-task-contract', SOURCE_PATHS.kernelTaskContract, [
    ...
    "surface: 'vscode'",
    "input.taskContract.qualityObligations.includes('validation')",
  ...
  check('vscode-task-contract-data-boundary', SOURCE_PATHS.taskContract, [
    'export interface TaskContract',
    'Structured task facts accumulated from normalized model actions and local',
    'export function hasSourceClaimArtifactContract(',
    'contract.verificationContract.requireSourceClaimGrounding',
  ], ['buildTaskContract(', 'RegExp', 'userPrompt']),
...
function buildSemanticDomains() {
  return [
    ...
    domain('model-action-task-contract', 'CodingModelActionObservation', [
      owner('shared-projectCodingModelActionTaskContract', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedModelActionContract),
    ], []),
    ...
    domain('code-change', 'CodeChangePort', [
      owner('shared-CanonicalCodeChangeService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedCodeChange),
    ], []),
    domain('integration-conformance', 'IntegrationConformancePort', [
      owner('shared-CanonicalIntegrationConformanceService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedIntegrationConformance),
    ], []),
    ...
    domain('diagnostic-normalization', 'DiagnosticPort', [
      owner('shared-CanonicalDiagnosticService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedDiagnostic),
    ], []),
    domain('regression-selection', 'RegressionSelectionPort', [
      owner('shared-CanonicalRegressionSelectionService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedRegressionSelection),
    ], []),
    domain('bounded-repair', 'RepairDecisionPort', [
      owner('shared-CanonicalRepairDecisionService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedRepairDecision),
    ], []),
    domain('independent-review', 'IndependentReviewPort', [
      owner('shared-CanonicalIndependentReviewService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedIndependentReview),
    ], []),
    domain('artifact-identity', 'ArtifactIdentityPort', [
      owner('shared-CanonicalArtifactIdentityService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedArtifactIdentity),
    ], []),
    domain('git-delivery', 'GitDeliveryPort', [
      owner('shared-CanonicalGitDeliveryService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedDelivery),
    ], []),
    domain('delivery-manifest', 'DeliveryManifestPort', [
      owner('shared-CanonicalDeliveryManifestService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedDelivery),
    ], []),
    domain('release-gate', 'ReleaseGatePort', [
      owner('shared-CanonicalReleaseGateService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedRelease),
    ], []),
    domain('ci-deploy-observe', 'CiDeployObservePort', [
      owner('shared-CanonicalCiDeployObserveService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedRelease),
    ], []),
    domain('rollback', 'RollbackPort', [
      owner('shared-CanonicalRollbackService', ['vscode', 'cli', 'headless'], SOURCE_PATHS.sharedRelease),
    ], []),
