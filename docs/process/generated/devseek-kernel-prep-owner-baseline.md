...
| run-cancellation | shared-CanonicalRunControlService | - | 1 | converged |
| run-steering | shared-CanonicalRunControlService | - | 1 | converged |
| user-collaboration | shared-CanonicalUserCollaborationService | - | 1 | converged |
| surface-accessibility | shared-CanonicalSurfaceAccessibilityService | - | 1 | converged |
...
| kernel-environment | shared-CanonicalCodingKernelEnvironmentService | - | 1 | converged |
| provider-capability | shared-CanonicalProviderCapabilityService | - | 1 | converged |
| secret-redaction | shared-CanonicalSecretRedactionService | - | 1 | converged |
| dirty-worktree | shared-CanonicalDirtyWorktreePolicyService | - | 1 | converged |
| platform-adapter-conformance | shared-CanonicalPlatformAdapterConformanceService | - | 1 | converged |
| mcp-boundary | shared-CanonicalMcpBoundaryService | - | 1 | converged |
