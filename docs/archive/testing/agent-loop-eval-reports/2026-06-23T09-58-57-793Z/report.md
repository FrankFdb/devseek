...
- Run ID: 2026-06-23T09-58-57-793Z
- Command: `node scripts/devseek-agent-loop-eval.mjs`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T09-58-57-793Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T09-58-57-793Z/report.json`
...
| --- | --- | ---: | --- |
| L0-agent-core-protocol | passed | 21ms | events=chat.started,provider.selected,chat.delta,chat.delta,chat.completed |
| L1-cli-jsonl-mock | passed | 138ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 356ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 2261ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 2279ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
