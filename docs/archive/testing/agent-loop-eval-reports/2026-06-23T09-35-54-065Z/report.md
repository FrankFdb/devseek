...
- Run ID: 2026-06-23T09-35-54-065Z
- Command: `node scripts/devseek-agent-loop-eval.mjs`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T09-35-54-065Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T09-35-54-065Z/report.json`
...
| --- | --- | ---: | --- |
| L0-agent-core-protocol | passed | 17ms | events=chat.started,provider.selected,chat.delta,chat.delta,chat.completed |
| L1-cli-jsonl-mock | passed | 108ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 271ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 1824ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 1780ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
| L4-cli-real-deepseek-programming | skipped | 1ms | pass --real-deepseek or DEVSEEK_AGENT_LOOP_REAL_DEEPSEEK=1 to run live DeepSeek CLI smoke |
