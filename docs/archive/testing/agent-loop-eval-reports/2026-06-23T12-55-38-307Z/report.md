...
- Run ID: 2026-06-23T12-55-38-307Z
- Command: `node scripts/devseek-agent-loop-eval.mjs --real-deepseek`
- Result: FAIL
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T12-55-38-307Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T12-55-38-307Z/report.json`
...
| --- | --- | ---: | --- |
| L0-agent-core-protocol | passed | 18ms | events=chat.started,provider.selected,chat.delta,chat.delta,chat.completed |
| L1-cli-jsonl-mock | passed | 129ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 285ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 1991ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 1770ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
| L4-cli-real-deepseek-programming | failed | 223ms | baseline |

## Findings

| ID | Case | Severity | Category | Status | Diagnosis | Next action |
| --- | --- | --- | --- | --- | --- | --- |
| F1 | L4-cli-real-deepseek-programming | low | real-provider-environment | open | The live Provider path is unavailable or unstable; this is not enough evidence for a DevSeek logic bug. | Capture prompt/response logs, verify Bridge/login/network state, and rerun without changing product logic first. |
...
- Do not promote the affected live layer yet; classify the finding, add a deterministic replay when possible, and rerun.
