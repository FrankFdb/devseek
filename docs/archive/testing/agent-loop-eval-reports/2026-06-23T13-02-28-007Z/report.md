...
- Run ID: 2026-06-23T13-02-28-007Z
- Command: `node scripts/devseek-agent-loop-eval.mjs --real-deepseek`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T13-02-28-007Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T13-02-28-007Z/report.json`
...
| --- | --- | ---: | --- |
| L0-agent-core-protocol | passed | 20ms | events=chat.started,provider.selected,chat.delta,chat.delta,chat.completed |
| L1-cli-jsonl-mock | passed | 146ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 345ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 2258ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 2264ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
| L4-cli-real-deepseek-programming | passed | 33091ms | tool-json, output=DEVSEEK_CLI_REAL_DEEPSEEK_CODE_OK |
