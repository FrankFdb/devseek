...
- Run ID: 2026-06-25T08-46-39-629Z
- Command: `node scripts/devseek-agent-loop-eval.mjs`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-25T08-46-39-629Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-25T08-46-39-629Z/report.json`
...
| --- | --- | ---: | --- |
| L0-agent-core-protocol | passed | 4ms | events=chat.started,provider.selected,chat.delta,chat.delta,chat.completed |
| L1-cli-jsonl-mock | passed | 43ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 157ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 707ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 741ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
