...
- Run ID: 2026-06-23T12-57-31-305Z
- Command: `node scripts/devseek-agent-loop-eval.mjs --real-deepseek`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T12-57-31-305Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T12-57-31-305Z/report.json`
...
| L1-cli-jsonl-mock | passed | 132ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 316ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 2141ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 2184ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
| L4-cli-real-deepseek-programming | passed | 33009ms | tool-json, output=DEVSEEK_CLI_REAL_DEEPSEEK_CODE_OK |
