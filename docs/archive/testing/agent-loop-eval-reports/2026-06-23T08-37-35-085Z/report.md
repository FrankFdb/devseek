...
- Run ID: 2026-06-23T08-37-35-085Z
- Command: `node scripts/devseek-agent-loop-eval.mjs --real-deepseek`
- Result: FAIL
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T08-37-35-085Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T08-37-35-085Z/report.json`
...
| L2-cli-fake-bridge-sse | passed | 146ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 660ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 818ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
| L4-cli-real-deepseek-programming | failed | 78ms | baseline |
