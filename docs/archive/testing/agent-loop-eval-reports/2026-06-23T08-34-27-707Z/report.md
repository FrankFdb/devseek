...
- Run ID: 2026-06-23T08-34-27-707Z
- Command: `node scripts/devseek-agent-loop-eval.mjs`
- Result: PASS
- Artifact JSON: `artifacts/agent-loop-eval/2026-06-23T08-34-27-707Z/report.json`
- Testing JSON: `docs/testing/agent-loop-eval-reports/2026-06-23T08-34-27-707Z/report.json`
...
| L1-cli-jsonl-mock | passed | 33ms | events=chat.started,provider.selected,chat.completed |
| L2-cli-fake-bridge-sse | passed | 107ms | fake-sse |
| L3-cli-fake-bridge-programming | passed | 572ms | tool-json, output=DEVSEEK_CLI_FAKE_BRIDGE_CODE_OK |
| L3b-cli-loose-tool-json-recovery | passed | 676ms | tool-json-recovered, output=DEVSEEK_CLI_LOOSE_JSON_RECOVERY_OK |
