...
- Run ID: 2026-06-23T09-30-59-925Z
- Target: Claude Code/Codex baseline coding-agent behavior
- Result: FAIL
- Artifact JSON: `artifacts/programming-agent-benchmark/2026-06-23T09-30-59-925Z/report.json`
- Testing JSON: `docs/testing/programming-agent-benchmark-reports/2026-06-23T09-30-59-925Z/report.json`
...
| --- | --- | ---: | --- |
| PA0-cli-jsonl-sanity | passed | 138ms | events=chat.started,provider.selected,chat.completed |
| PA1-create-file-apply-compile | passed | 2135ms | output=PA1_CREATE_FILE_OK |
| PA2-modify-existing-preserve-behavior | passed | 2891ms | output=ADD:5<br>MUL:6 |
| PA3-test-repair-loop | passed | 2316ms | output=PA3_REPAIR_OK |
| PA4-agent-evidence-events | passed | 969ms | events=chat.started,provider.selected,provider.status,provider.status,chat.completed,fileChanges.proposed,validation.completed,qualityGate.completed |
| PA5-unified-diff-apply | passed | 2475ms | output=ADD:5<br>MUL:6<br>DIV:2 |
| PA6-project-test-command | passed | 1154ms | output=PA6_PROJECT_TEST_OK |
| PA7-staged-incremental-requirement | failed | 3096ms | AssertionError [ERR_ASSERTION]: DevSeek did not pass the existing source file as model context for the incremental requirement false !== true at stagedIncrementalRequirementCase (file:///home/ff/work/devseek_netai/scripts/devseek-programming-agent-benchmark.mjs:375:10) at process.processTicksAndRejections (node:internal/process/task_queues:103:5) at async runCase (file:///home/ff/work/devseek_netai/scripts/devseek-programming-agent-benchmark.mjs:54:21) at async main (file:///home/ff/work/devseek |
| PA8-interactive-stdin-verifier | failed | 1742ms | AssertionError [ERR_ASSERTION]: DevSeek CLI error: DevSeek coding validation failed after repair: .devseek/bin/src_interactive exited 2 1 !== 0 at file:///home/ff/work/devseek_netai/scripts/devseek-programming-agent-benchmark.mjs:427:12 at process.processTicksAndRejections (node:internal/process/task_queues:103:5) at async withFakeBridge (file:///home/ff/work/devseek_netai/scripts/devseek-programming-agent-benchmark.mjs:474:5) at async interactiveVerifierCase (file:///home/ff/work/devseek_netai/ |
...
| F2 | PA8-interactive-stdin-verifier | high | missing-project-verifier | DevSeek did not discover/run the project test command or include that evidence in validation events. | Run npm test when a package.json test script exists and project files changed, then rerun PA6. |
