...
- Run ID: 2026-06-25T08-48-11-989Z
- Target: Claude Code/Codex baseline coding-agent behavior
- Result: PASS
- Artifact JSON: `artifacts/programming-agent-benchmark/2026-06-25T08-48-11-989Z/report.json`
- Testing JSON: `docs/testing/programming-agent-benchmark-reports/2026-06-25T08-48-11-989Z/report.json`
...
| --- | --- | ---: | --- |
| PA0-cli-jsonl-sanity | passed | 77ms | events=chat.started,provider.selected,chat.completed |
| PA1-create-file-apply-compile | passed | 809ms | output=PA1_CREATE_FILE_OK |
| PA2-modify-existing-preserve-behavior | passed | 1103ms | output=ADD:5<br>MUL:6 |
| PA3-test-repair-loop | passed | 913ms | output=PA3_REPAIR_OK |
| PA4-agent-evidence-events | passed | 375ms | events=chat.started,provider.selected,provider.status,provider.status,chat.completed,fileChanges.proposed,validation.completed,qualityGate.completed |
| PA5-unified-diff-apply | passed | 934ms | output=ADD:5<br>MUL:6<br>DIV:2 |
| PA6-project-test-command | passed | 492ms | output=PA6_PROJECT_TEST_OK |
| PA7-staged-incremental-requirement | passed | 1490ms | output=SCORE:10<br>BONUS:15 |
| PA8-interactive-stdin-verifier | passed | 733ms | output=Hello Alice<br>SUM:7 |
| PA9-multifile-devseek-verifier | passed | 408ms | output=MULTI:42 |
| PA10-python-verifier-command | passed | 112ms | output=PYWORDS:3 |
| PA11-implicit-project-context | passed | 437ms | output=PA11_CONTEXT_OK |
| PA12-path-safety-guard | passed | 78ms | output=unsafe write refused |
