...
- Run ID: 2026-06-23T13-03-17-204Z
- Target: Claude Code/Codex baseline coding-agent behavior
- Result: PASS
- Artifact JSON: `artifacts/programming-agent-benchmark/2026-06-23T13-03-17-204Z/report.json`
- Testing JSON: `docs/testing/programming-agent-benchmark-reports/2026-06-23T13-03-17-204Z/report.json`
...
| --- | --- | ---: | --- |
| PA0-cli-jsonl-sanity | passed | 155ms | events=chat.started,provider.selected,chat.completed |
| PA1-create-file-apply-compile | passed | 2294ms | output=PA1_CREATE_FILE_OK |
| PA2-modify-existing-preserve-behavior | passed | 3202ms | output=ADD:5<br>MUL:6 |
| PA3-test-repair-loop | passed | 2936ms | output=PA3_REPAIR_OK |
| PA4-agent-evidence-events | passed | 1260ms | events=chat.started,provider.selected,provider.status,provider.status,chat.completed,fileChanges.proposed,validation.completed,qualityGate.completed |
| PA5-unified-diff-apply | passed | 3215ms | output=ADD:5<br>MUL:6<br>DIV:2 |
| PA6-project-test-command | passed | 1356ms | output=PA6_PROJECT_TEST_OK |
| PA7-staged-incremental-requirement | passed | 4279ms | output=SCORE:10<br>BONUS:15 |
| PA8-interactive-stdin-verifier | passed | 2092ms | output=Hello Alice<br>SUM:7 |
| PA9-multifile-devseek-verifier | passed | 1242ms | output=MULTI:42 |
| PA10-python-verifier-command | passed | 328ms | output=PYWORDS:3 |
| PA11-implicit-project-context | passed | 1302ms | output=PA11_CONTEXT_OK |
| PA12-path-safety-guard | passed | 242ms | output=unsafe write refused |
