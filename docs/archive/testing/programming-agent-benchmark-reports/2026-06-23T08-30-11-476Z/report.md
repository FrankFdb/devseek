...
- Run ID: 2026-06-23T08-30-11-476Z
- Target: Claude Code/Codex baseline coding-agent behavior
- Result: PASS
- Artifact JSON: `artifacts/programming-agent-benchmark/2026-06-23T08-30-11-476Z/report.json`
- Testing JSON: `docs/testing/programming-agent-benchmark-reports/2026-06-23T08-30-11-476Z/report.json`
...
| --- | --- | ---: | --- |
| PA0-cli-jsonl-sanity | passed | 47ms | events=chat.started,provider.selected,chat.completed |
| PA1-create-file-apply-compile | passed | 565ms | output=PA1_CREATE_FILE_OK |
| PA2-modify-existing-preserve-behavior | passed | 806ms | output=ADD:5<br>MUL:6 |
| PA3-test-repair-loop | passed | 666ms | output=PA3_REPAIR_OK |
| PA4-agent-evidence-events | passed | 329ms | events=chat.started,provider.selected,provider.status,provider.status,chat.completed,fileChanges.proposed,validation.completed,qualityGate.completed |
| PA5-unified-diff-apply | passed | 771ms | output=ADD:5<br>MUL:6<br>DIV:2 |
| PA6-project-test-command | passed | 360ms | output=PA6_PROJECT_TEST_OK |
