...
- Run ID: 2026-06-23T09-35-54-214Z
- Target: Claude Code/Codex baseline coding-agent behavior
- Result: PASS
- Artifact JSON: `artifacts/programming-agent-benchmark/2026-06-23T09-35-54-214Z/report.json`
- Testing JSON: `docs/testing/programming-agent-benchmark-reports/2026-06-23T09-35-54-214Z/report.json`
...
| --- | --- | ---: | --- |
| PA0-cli-jsonl-sanity | passed | 101ms | events=chat.started,provider.selected,chat.completed |
| PA1-create-file-apply-compile | passed | 1816ms | output=PA1_CREATE_FILE_OK |
| PA2-modify-existing-preserve-behavior | passed | 2501ms | output=ADD:5<br>MUL:6 |
| PA3-test-repair-loop | passed | 2259ms | output=PA3_REPAIR_OK |
| PA4-agent-evidence-events | passed | 1074ms | events=chat.started,provider.selected,provider.status,provider.status,chat.completed,fileChanges.proposed,validation.completed,qualityGate.completed |
| PA5-unified-diff-apply | passed | 2562ms | output=ADD:5<br>MUL:6<br>DIV:2 |
| PA6-project-test-command | passed | 1193ms | output=PA6_PROJECT_TEST_OK |
| PA7-staged-incremental-requirement | passed | 4123ms | output=SCORE:10<br>BONUS:15 |
| PA8-interactive-stdin-verifier | passed | 2026ms | output=Hello Alice<br>SUM:7 |
