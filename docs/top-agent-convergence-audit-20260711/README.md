...
- 审计日期：2026-07-11
- 实施检查点：2026-07-12，G0-A 已完成，Gate 0 整体尚未通过
- 审计基线：`591a266`
- 状态：下一阶段方向决策与专项迭代输入
...
| [10-G0-A机器能力账本实施与迭代计划.md](10-G0-A机器能力账本实施与迭代计划.md) | G0-A 实施证据、机器账本边界及 G0-B/C/D 后续作业 |

建议新迭代窗口按 `README → 10 → 09 → 08 → 04 → 05` 阅读；需要理解架构与历史原因时再读 `01～03、07`。
