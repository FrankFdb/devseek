...
release_identity: PENDING_SOURCE_COMMIT_AND_RELEASE_LOOP; source has passed focused/full verification and still requires implementation commit, debug VSIX package, packaged Bridge verification, local install, and current-candidate runtime identity convergence.
