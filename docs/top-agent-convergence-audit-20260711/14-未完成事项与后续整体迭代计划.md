...
release_loop: TO_RUN_FROM_THIS_COMMIT because Extension runtime behavior changed; exact VSIX SHA/build/install/controlled single-window harness evidence must be reported after packaging this checkpoint commit.
