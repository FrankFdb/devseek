...
- Run ID: `20260813-t1540-local-acceptance-g77028cb-focused-rerun`
- Execution mode: `execute`

- Result: `PASS`
- Evidence root: `code/devseek-tests/top-agent-convergence/runs/20260813-t1540-local-acceptance-g77028cb-focused-rerun`
...
| --- | --- | --- | --- |
| `controlled-realistic-product` | PASS | `controlled-vsix-user-simulation` | `code/devseek-tests/top-agent-convergence/runs/20260813-t1540-local-acceptance-g77028cb-focused-rerun/realistic-product.stdout.log` |
...
- start: pid=4136 scope=vscode-host cpu=54.5% rss=1938MB cmd=`/usr/share/code/code --type=zygote`
- before-controlled-realistic-product: pid=4136 scope=vscode-host cpu=54.5% rss=1938MB cmd=`/usr/share/code/code --type=zygote`
- after-controlled-realistic-product: pid=4136 scope=vscode-host cpu=54.5% rss=1948MB cmd=`/usr/share/code/code --type=zygote`
- end: pid=4136 scope=vscode-host cpu=54.5% rss=1948MB cmd=`/usr/share/code/code --type=zygote`

Residual controlled VSIX cleanup:
- Sent SIGTERM to pid=343346 for `/tmp/devseek-controlled-vsix-PPovXq/user-data`.
- Sent SIGTERM to pid=343333 for `/tmp/devseek-controlled-vsix-PPovXq/user-data`.
- Sent SIGTERM to pid=343328 for `/tmp/devseek-controlled-vsix-PPovXq/user-data`.
- Sent SIGTERM to pid=343363 for `/tmp/devseek-controlled-vsix-PPovXq/user-data/Crashpad`.

Retained controlled VSIX windows:
- Retained `/tmp/devseek-controlled-vsix-RD3CKk` for inspection; workspace `/tmp/devseek-controlled-vsix-RD3CKk/workspace`.
